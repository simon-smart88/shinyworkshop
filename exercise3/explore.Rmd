...
ward_summary <- ward_values %>% group_by(ward) %>% summarise(mean_fcover = (sum(fcover * fraction))/n())

hist(ward_summary$mean_fcover)



ward_fcover <- terra::crop(fcover, wards[wards$NAME == wards$NAME[1],], mask = TRUE)
